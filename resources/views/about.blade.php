    ...
    <div class="wrapper">
        ...
        <div class="flex flex-row mb-10">
            ...
            <div class="flex-none w-48">
                <img class="w-full object-contain rounded-full shadow-md" src="{{ asset('images/Keirstan-Kure.jpg') }}" alt="">
            </div>
            ...
            <div class="flex flex-col self-center ml-10">
                        ...
                        <div>
                            <a href="#">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope-square"
                                    class="w-5 mx-1 fill-current text-dark-secondary hover:text-green-500" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512">
                                    <path fill="currentColor"
                ...
                <div>
                    <p class="text-dark font-text-regular text-sm mb-4">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore
                    magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd
                    gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing
                    elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos</p>
                </div>
